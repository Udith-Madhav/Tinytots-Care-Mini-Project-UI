...
class Dbooking2 extends StatefulWidget {
  const Dbooking2({super.key});

  @override
  State<Dbooking2> createState() => _Dbooking2State();
}

class _Dbooking2State extends State<Dbooking2> {
  int indexNumber=0;
  List tabWidget =[
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          SizedBox(height: 20,),
                          Text("Dr.Antony",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20,fontFamily: 'GravitasOne'),),
                          Text("Visiting Time",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20,)),
                          Text("02:30 pm - 4:30 pm",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20,)),
                        ],
                      )
                    ],
                  ),
